...
import movieDB from '../MyMovieDB';
import MyMovie from './MyMovie';

export const MyMovieRow = ({ moviet, title, rowId}) => {
    const filteredMovies = movieDB.filter(moviet => {
            return moviet.category === title;
        });
   ...
   return (
        ...
        <div className="relative flex moviets-center group" >
       ...
       {filteredMovies.map((moviet, id) => ( <MyMovie key={id} moviet={moviet}/> ))}
        </div>
